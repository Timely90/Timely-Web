                    ...
                    <div className="flex items-center justify-center w-full lg:p-12">
                        <div className=" w-full h-full flex items-center xl:p-10">
                            <form onSubmit={handleSubmitPassEmail}
                                ...
                                <button type="submit"
                                    className="w-full px-6 py-5 mb-36 mt-5 text-sm font-bold leading-none text-white transition duration-300 md:w-96 rounded bg-purple-500 hover:bg-purple-600 focus:ring-purple-700"
                                >
                                    Actualizar
                                </button>
                            </form>
